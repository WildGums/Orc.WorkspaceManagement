    ...
    where TControl : FrameworkElement
{
    ...
    protected override bool TryLoadControl(TestHostAutomationControl testHost, out string testedControlAutomationId)
    {
        ...
        testHost.TryLoadAssembly(Path.Combine(testDirectory, "Orc.WorkspaceManagement.dll"));
        testHost.TryLoadAssembly(Path.Combine(testDirectory, "Orc.WorkspaceManagement.Xaml.dll"));
        testHost.TryLoadAssembly(Path.Combine(testDirectory, "Orc.WorkspaceManagement.Tests.dll"));

        testHost.TryLoadResources("pack://application:,,,/Orc.Theming;component/Themes/Generic.xaml");
        testHost.TryLoadResources("pack://application:,,,/Orc.WorkspaceManagement.Xaml;component/Themes/Generic.xaml");
